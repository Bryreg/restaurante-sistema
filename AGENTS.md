...
| Caja | **El cajón abre sólo con los sobres por consignar** que quien abre elige y cuenta a ciegas, y la **base de respaldo** (monto fijo por sede, la única cosa que se llama «base») vive aparte, con libro propio, préstamo que vuelve antes del cierre y verificación del custodio (decisión del dueño 2026-09-26; los turnos de antes conservan su base fija, `docs/SPEC-NEGOCIO.md §3.2`); una caja por sede y por turno con responsable; cierre **a ciegas en tres pasos** con causa tipada; tolerancias que alertan y nunca bloquean; el sistema **nunca calcula deuda de un empleado** (CST art. 149). | Elimina el cuadre por saldos de días anteriores y la cascada entre días que la referencia necesitó y que fabricaron sobrantes dobles. |
