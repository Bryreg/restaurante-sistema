 ...
 * `app/orders/router.py`: counter→dine_in, dine_in→dine_in, takeout→takeout,
 * staff_meal→dine_in).
 */
export function channelPriceKey(channel: string | null | undefined): "dine_in" | "takeout" {
  return channel === "takeout" ? "takeout" : "dine_in"
}
